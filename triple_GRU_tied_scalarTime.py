...
class TripleAttention(nn.Module):
    ...
    def forward(self,vocal,vision,emb):
        ...
        # Visual Attention
        h_two_vision = F.tanh(self.Wvision_1(vision))*F.tanh(self.Wvision_m1(m_one_vision))
        ...
        # Vocal Attention
        h_two_vocal = F.tanh(self.Wvocal_1(vocal))*F.tanh(self.Wvocal_m1(m_one_vocal))
        ...
        # Emb Attention
        h_two_emb = F.tanh(self.Wemb_1(emb))*F.tanh(self.Wemb_m1(m_one_emb))
        ...
        # Visual Attention
        h_three_vision = F.tanh(self.Wvision_1(vision))*F.tanh(self.Wvision_m1(m_two_vision))
        ...
        # Vocal Attention
        h_three_vocal = F.tanh(self.Wvocal_1(vocal))*F.tanh(self.Wvocal_m1(m_two_vocal))
        ...
        # Emb Attention
        h_three_emb = F.tanh(self.Wemb_1(emb))*F.tanh(self.Wemb_m1(m_two_emb))
