...
critetion = nn.SmoothL1Loss(size_average=False) # Huber Loss
...
def save_checkpoint(state, filename = 'MSE_Loss_sum'):
...
while epoch < no_of_epochs:
	...
	if use_pretrained:
		...
		pretrained_file = './random_models/MSE_Loss_sum.pth.tar'
