...
modules = list(resnet.children())[:-2]      # delete the last fc layer and the avg.pool layer
...
params =  list(Vocal_encoder.parameters()) + list(Attention.parameters()) +list(resnet.parameters())
