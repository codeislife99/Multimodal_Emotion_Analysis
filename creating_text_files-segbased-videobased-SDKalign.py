...
for key,value in data.items():
	...
	for key2,value2 in value.items():
		if key2 in train_data: 
			...
			videobased_folder_location = "./text_files_videobased_align/train/"
		elif key2 in valid_data: 
			folder_location = "./text_files_segbased_align/val/"
			videobased_folder_location = "./text_files_videobased_align/val/"
		else: 
			folder_location = "./text_files_segbased_align/test/"
			videobased_folder_location = "./text_files_videobased_align/test/"
		video_name = key2
